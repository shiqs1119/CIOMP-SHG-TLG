...
Program workfile
    ...
    real(8), parameter :: s0 = e**(2.d0)/(4*h_bar)
    ...
    open(1, file = 'numk5000.txt' , status = 'new')
    do i1 = 1, numw
        write(1,'(100es32.16,1x)')w(i1), real(Sigma(1, 1, i1))/s0,aimag(Sigma(1,1,i1))/s0
        write(*,*)i1
    end do    
    close(1)
